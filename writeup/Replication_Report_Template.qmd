...
This means that if *N* = 119 and the real effect size *r* = 0.10, we have about 83% of failing to detect this effect sizes. Theoretically, we need 
much more sample sizes to capture this limited effect sizes. For example, if we would like to acheive 80% of statistical power, **total 781 samples** are required. 
