...
> [!CAUTION]
> Also, the key analytic package - `DIM` is on-going project in [UCSD SciMinds Research Studio](https://www.sciminds.studio/). For this reason, the directory of `DIM` was not shared in this repository. For the sharing request, please contact the project lead: Jinwoo Lee ([jil527@ucsd.edu](jil527@ucsd.edu)).
